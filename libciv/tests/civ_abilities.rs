...
fn test_mamluk_heals_every_turn() {
    ...
    s.state.units.push(BasicUnit {
        ...
        promotions: Vec::new(), health: 60, range: 0, vision_range: 2, charges: None, trade_origin: None, trade_destination: None, religion_id: None, spread_charges: None, religious_strength: None,
    });
