...
use crate::{
    AgeType, BarbarianCampId, BeliefId, CityId, CivId, GovernorId, GreatPersonId, GreatPersonType,
...
pub enum StateDelta {
    ...
    ReligiousPressureApplied {
        city: CityId,
        religion: ReligionId,
        delta: i32,
    },
    /// A city's majority religion changed.
    CityConvertedReligion {
        city: CityId,
        old_religion: Option<ReligionId>,
        new_religion: ReligionId,
    },
    ...
    HeresyRemoved {
        city: CityId,
        followers_removed: u32,
    },
    /// A Guru healed nearby religious units.
    ReligiousUnitsHealed {
        healer: UnitId,
        healed_count: u32,
    },
    ...
    BarbarianCampSpawned {
        camp: BarbarianCampId,
        coord: HexCoord,
    },
