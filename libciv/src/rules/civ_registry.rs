...
pub fn rome() -> CivAbilityBundle {
    CivAbilityBundle {
        ...
        unique_district: Some(UniqueDistrictDef {
            ...
            base_cost: 36,
            extra_yields: YieldBundle::default(),
            extra_housing: 2,
            extra_amenities: 1,
            placement: None,
...
pub fn greece() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Greece,
        leader: BuiltinLeader::Pericles,
        civ_name: "Greece",
        adjective: "Greek",
        ...
        unique_district: Some(UniqueDistrictDef {
            ...
            adjacency_overrides: vec![AdjacencyOverride {
...
pub fn egypt() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Egypt,
        leader: BuiltinLeader::Cleopatra,
        civ_name: "Egypt",
        adjective: "Egyptian",
        ...
        leader_modifiers: vec![Modifier::new(
...
pub fn babylon() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Babylon,
        leader: BuiltinLeader::Hammurabi,
        civ_name: "Babylon",
...
pub fn germany() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Germany,
        leader: BuiltinLeader::Barbarossa,
        civ_name: "Germany",
        adjective: "German",
        leader_name: "Barbarossa",
...
pub fn japan() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Japan,
        leader: BuiltinLeader::Hojo,
        civ_name: "Japan",
        adjective: "Japanese",
        leader_name: "Hojo Tokimune",
...
pub fn india() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::India,
        leader: BuiltinLeader::Gandhi,
        civ_name: "India",
        adjective: "Indian",
        leader_name: "Gandhi",
...
pub fn arabia() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Arabia,
        leader: BuiltinLeader::Saladin,
        civ_name: "Arabia",
        adjective: "Arabian",
        leader_name: "Saladin",
...
pub fn america() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::America,
        leader: BuiltinLeader::Roosevelt,
        civ_name: "America",
        adjective: "American",
        leader_name: "Teddy Roosevelt",
        ...
        unique_building: Some(UniqueBuildingDef {
            civ: BuiltinCiv::America,
            name: "film_studio",
            replaces: Some("broadcast_center"),
            cost: 580,
            maintenance: 3,
...
pub fn brazil() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Brazil,
        leader: BuiltinLeader::Pedro,
        civ_name: "Brazil",
        adjective: "Brazilian",
        leader_name: "Pedro II",
...
pub fn china() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::China,
        leader: BuiltinLeader::QinShiHuang,
        civ_name: "China",
        adjective: "Chinese",
...
pub fn england() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::England,
        leader: BuiltinLeader::Victoria,
        civ_name: "England",
        adjective: "English",
...
pub fn france() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::France,
        leader: BuiltinLeader::Catherine,
        civ_name: "France",
        adjective: "French",
        leader_name: "Catherine de Medici",
        ...
        civ_modifiers: vec![Modifier::new(
...
pub fn kongo() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Kongo,
        leader: BuiltinLeader::Mvemba,
        civ_name: "Kongo",
        adjective: "Kongolese",
        leader_name: "Mvemba a Nzinga",
...
pub fn norway() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Norway,
        leader: BuiltinLeader::Harald,
        civ_name: "Norway",
        adjective: "Norwegian",
        leader_name: "Harald Hardrada",
...
pub fn russia() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Russia,
        leader: BuiltinLeader::Peter,
        civ_name: "Russia",
        adjective: "Russian",
        leader_name: "Peter",
        ...
        civ_modifiers: vec![
            ...
            .with_condition(Condition::TileHasFeature(
                crate::world::feature::BuiltinFeature::Forest,
            )),
            Modifier::new(
                ModifierSource::CivAbility("Mother Russia"),
                TargetSelector::AllTiles,
...
pub fn scythia() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Scythia,
        leader: BuiltinLeader::Tomyris,
        civ_name: "Scythia",
        adjective: "Scythian",
        leader_name: "Tomyris",
        ...
        unique_improvement: Some(UniqueImprovementDef {
            ...
            base_yields: YieldBundle::new()
                ...
                .with(YieldType::Faith, 1),
            appeal_modifier: 0,
            adjacency_bonuses: vec![ImprovementAdjacencyBonus {
...
pub fn spain() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Spain,
        leader: BuiltinLeader::Philip,
        civ_name: "Spain",
        adjective: "Spanish",
        leader_name: "Philip II",
...
pub fn sumeria() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Sumeria,
        leader: BuiltinLeader::Gilgamesh,
        civ_name: "Sumeria",
        adjective: "Sumerian",
...
pub fn canada() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Canada,
        leader: BuiltinLeader::Laurier,
        civ_name: "Canada",
        adjective: "Canadian",
...
pub fn hungary() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Hungary,
        leader: BuiltinLeader::MatthiasCorvinus,
        civ_name: "Hungary",
        adjective: "Hungarian",
        leader_name: "Matthias Corvinus",
...
pub fn inca() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Inca,
        leader: BuiltinLeader::Pachacuti,
        civ_name: "Inca",
        adjective: "Incan",
        leader_name: "Pachacuti",
...
pub fn mali() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Mali,
        leader: BuiltinLeader::MansaMusa,
        civ_name: "Mali",
        adjective: "Malian",
        leader_name: "Mansa Musa",
        ...
        unique_improvement: None,
        on_city_founded: vec![],
        rule_overrides: vec![RuleOverride::MineGoldBonusProductionMalus {
            mine_gold: 4,
...
pub fn maori() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Maori,
        leader: BuiltinLeader::Kupe,
        civ_name: "Maori",
        adjective: "Maori",
        leader_name: "Kupe",
...
pub fn ottoman() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Ottoman,
        leader: BuiltinLeader::Suleiman,
        civ_name: "Ottoman",
        adjective: "Ottoman",
        leader_name: "Suleiman",
...
pub fn phoenicia() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Phoenicia,
        leader: BuiltinLeader::Dido,
        civ_name: "Phoenicia",
...
pub fn sweden() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Sweden,
        leader: BuiltinLeader::Kristina,
        civ_name: "Sweden",
        adjective: "Swedish",
        leader_name: "Kristina",
...
pub fn cree() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Cree,
        leader: BuiltinLeader::Poundmaker,
        civ_name: "Cree",
        adjective: "Cree",
        leader_name: "Poundmaker",
...
pub fn georgia() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Georgia,
        leader: BuiltinLeader::Tamar,
        civ_name: "Georgia",
        adjective: "Georgian",
        leader_name: "Tamar",
        ...
        unique_building: Some(UniqueBuildingDef {
            civ: BuiltinCiv::Georgia,
            name: "tsikhe",
            replaces: Some("renaissance_walls"),
            cost: 240,
            maintenance: 0,
            yields: YieldBundle::new().with(YieldType::Faith, 3),
            requires_district: None,
...
pub fn korea() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Korea,
        leader: BuiltinLeader::Seondeok,
        civ_name: "Korea",
        adjective: "Korean",
...
pub fn mapuche() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Mapuche,
        leader: BuiltinLeader::Lautaro,
        civ_name: "Mapuche",
        adjective: "Mapuche",
        leader_name: "Lautaro",
...
pub fn mongolia() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Mongolia,
        leader: BuiltinLeader::GenghisKhan,
        civ_name: "Mongolia",
        adjective: "Mongolian",
...
pub fn netherlands() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Netherlands,
        leader: BuiltinLeader::Wilhelmina,
        civ_name: "Netherlands",
        adjective: "Dutch",
        leader_name: "Wilhelmina",
...
pub fn scotland() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Scotland,
        leader: BuiltinLeader::RobertTheBruce,
        civ_name: "Scotland",
        adjective: "Scottish",
        ...
        on_city_founded: vec![],
        rule_overrides: vec![RuleOverride::HappyCityBonus {
            science_percent: 5,
...
pub fn australia() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Australia,
        leader: BuiltinLeader::JohnCurtin,
        civ_name: "Australia",
        adjective: "Australian",
        leader_name: "John Curtin",
...
pub fn aztec() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Aztec,
        leader: BuiltinLeader::Montezuma,
        civ_name: "Aztec",
        adjective: "Aztec",
...
pub fn byzantium() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Byzantium,
        leader: BuiltinLeader::BasilII,
        civ_name: "Byzantium",
        adjective: "Byzantine",
        leader_name: "Basil II",
...
pub fn ethiopia() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Ethiopia,
        leader: BuiltinLeader::MenelikII,
        civ_name: "Ethiopia",
        adjective: "Ethiopian",
        leader_name: "Menelik II",
        ...
        on_city_founded: vec![],
        rule_overrides: vec![RuleOverride::HillsYieldBonus {
            science_percent: 15,
            culture_percent: 15,
        }],
    }
...
pub fn gran_colombia() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::GranColombia,
        leader: BuiltinLeader::SimonBolivar,
        civ_name: "Gran Colombia",
        adjective: "Gran Colombian",
        leader_name: "Simon Bolivar",
...
pub fn maya() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Maya,
        leader: BuiltinLeader::LadySixSky,
        civ_name: "Maya",
        adjective: "Mayan",
        leader_name: "Lady Six Sky",
        ...
        unique_improvement: None,
        on_city_founded: vec![],
        rule_overrides: vec![RuleOverride::YieldBonusPerNearbyCity {
            percent_per_city: 5,
            max_range: 6,
        }],
    }
...
pub fn indonesia() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Indonesia,
        leader: BuiltinLeader::Gitarja,
        civ_name: "Indonesia",
...
pub fn khmer() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Khmer,
        leader: BuiltinLeader::JayavarmanVII,
        civ_name: "Khmer",
        adjective: "Khmer",
        leader_name: "Jayavarman VII",
...
pub fn vietnam() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Vietnam,
        leader: BuiltinLeader::BaTrieu,
        civ_name: "Vietnam",
        adjective: "Vietnamese",
        leader_name: "Ba Trieu",
...
pub fn macedon() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Macedon,
        leader: BuiltinLeader::Alexander,
        civ_name: "Macedon",
...
pub fn persia() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Persia,
        leader: BuiltinLeader::Cyrus,
        civ_name: "Persia",
        adjective: "Persian",
        leader_name: "Cyrus",
        ...
        on_city_founded: vec![],
        rule_overrides: vec![RuleOverride::SurpriseWarBonus {
            movement: 1,
            combat_strength: 5,
            turns: 10,
        }],
...
pub fn nubia() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Nubia,
        leader: BuiltinLeader::Amanitore,
        civ_name: "Nubia",
        adjective: "Nubian",
        leader_name: "Amanitore",
        ...
        on_city_founded: vec![],
        rule_overrides: vec![RuleOverride::RangedProductionBonusAndMineStrategic {
            ranged_percent: 20,
        }],
    }
}
...
pub fn poland() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Poland,
        leader: BuiltinLeader::Jadwiga,
        civ_name: "Poland",
        adjective: "Polish",
        leader_name: "Jadwiga",
...
pub fn portugal() -> CivAbilityBundle {
    CivAbilityBundle {
        civ: BuiltinCiv::Portugal,
        leader: BuiltinLeader::JoaoIII,
        civ_name: "Portugal",
        adjective: "Portuguese",
        leader_name: "Joao III",
