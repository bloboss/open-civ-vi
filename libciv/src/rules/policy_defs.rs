    ...
    vec![
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Survey",
                    TargetSelector::UnitType("Recon"),
                    EffectType::MovementBonus(100),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Veterancy",
                    TargetSelector::ProductionQueue,
                    EffectType::ProductionPercent(30),
                ),
            ],
        },
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Bastions",
                    TargetSelector::Global,
                    EffectType::CombatStrengthFlat(6),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Sack",
                    TargetSelector::AllUnits,
                    EffectType::YieldFlat(YieldType::Gold, 10),
                ),
            ],
        },
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Professional Army",
                    TargetSelector::Global,
                    EffectType::YieldPercent(YieldType::Gold, -50),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Finest Hour",
                    TargetSelector::UnitDomain(crate::UnitDomain::Land),
                    EffectType::CombatStrengthFlat(15),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Land Surveyors",
                    TargetSelector::Global,
                    EffectType::YieldPercent(YieldType::Gold, 20),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Natural Philosophy",
                    TargetSelector::DistrictAdjacency(BuiltinDistrict::Campus),
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    ...
                    EffectType::YieldPercent(YieldType::Faith, 100),
                ),
            ],
        },
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    ...
                    TargetSelector::DistrictAdjacency(BuiltinDistrict::Harbor),
                    EffectType::YieldPercent(YieldType::Gold, 100),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Trade Confederation",
                    TargetSelector::TradeRoutesOwned,
                    EffectType::TradeRouteYieldFlat(YieldType::Culture, 1),
                ),
                pol(
                    "Trade Confederation",
                    TargetSelector::TradeRoutesOwned,
                    EffectType::TradeRouteYieldFlat(YieldType::Science, 1),
                ),
            ],
        },
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Aesthetics",
                    TargetSelector::DistrictAdjacency(BuiltinDistrict::TheaterSquare),
                    EffectType::YieldPercent(YieldType::Culture, 100),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Craftsmen",
                    TargetSelector::DistrictAdjacency(BuiltinDistrict::IndustrialZone),
                    EffectType::YieldPercent(YieldType::Production, 100),
                ),
            ],
        },
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Town Charters",
                    TargetSelector::DistrictAdjacency(BuiltinDistrict::CommercialHub),
                    EffectType::YieldPercent(YieldType::Gold, 100),
                ),
            ],
        },
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Colonial Offices",
                    TargetSelector::Global,
                    EffectType::YieldPercent(YieldType::Food, 15),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Triangular Trade",
                    TargetSelector::TradeRoutesOwned,
                    EffectType::TradeRouteYieldFlat(YieldType::Faith, 1),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Colonial Taxes",
                    TargetSelector::Global,
                    EffectType::YieldPercent(YieldType::Gold, 25),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "New Deal",
                    TargetSelector::Global,
                    EffectType::YieldFlat(YieldType::Gold, -8),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Collectivization",
                    TargetSelector::Global,
                    EffectType::YieldFlat(YieldType::Food, 4),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Ecommerce",
                    TargetSelector::TradeRoutesOwned,
                    EffectType::TradeRouteYieldFlat(YieldType::Gold, 5),
                ),
                pol(
                    "Ecommerce",
                    TargetSelector::TradeRoutesOwned,
                    EffectType::TradeRouteYieldFlat(YieldType::Culture, 10),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    ...
                    TargetSelector::Global,
                    EffectType::YieldFlat(YieldType::Gold, 3),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    ...
                    TargetSelector::Global,
                    EffectType::YieldFlat(YieldType::Culture, 4),
                ),
            ],
        },
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Gunboat Diplomacy",
                    TargetSelector::Global,
                    EffectType::YieldFlat(YieldType::Culture, 3),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Invention",
                    TargetSelector::Global,
                    EffectType::YieldFlat(YieldType::GreatPersonPoints, 4),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    ...
                    TargetSelector::Global,
                    EffectType::YieldFlat(YieldType::GreatPersonPoints, 8),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Nobel Prize",
                    TargetSelector::Global,
                    EffectType::YieldFlat(YieldType::GreatPersonPoints, 16),
                ),
            ],
        },
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Space Race",
                    TargetSelector::ProductionQueue,
                    EffectType::ProductionPercent(10),
                ),
            ],
        },
        // ================================================================
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Force Modernization",
                    TargetSelector::Global,
                    EffectType::YieldPercent(YieldType::Gold, -75),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![
                ...
                pol(
                    "Market Economy",
                    TargetSelector::TradeRoutesOwned,
                    EffectType::TradeRouteYieldFlat(YieldType::Science, 2),
                ),
            ],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![pol(
                "Music Censorship",
                TargetSelector::Global,
                EffectType::YieldPercent(YieldType::Culture, -25),
            )],
        },
        ...
        PolicyDef {
            ...
            modifiers: vec![pol(
                "Future Victory Science",
                TargetSelector::Global,
                EffectType::YieldPercent(YieldType::Science, 20),
            )],
        },
        PolicyDef {
        ...
        PolicyDef {
            ...
            modifiers: vec![pol(
                "Future Victory Culture",
                TargetSelector::Global,
                EffectType::YieldPercent(YieldType::Culture, 20),
            )],
        },
        PolicyDef {
...
mod tests {
    ...
    fn test_policy_types_breakdown() {
        ...
        let mil = defs
            .iter()
            .filter(|d| d.policy_type == PolicyType::Military)
            .count();
        let eco = defs
            .iter()
            .filter(|d| d.policy_type == PolicyType::Economic)
            .count();
        let dip = defs
            .iter()
            .filter(|d| d.policy_type == PolicyType::Diplomatic)
            .count();
        let wc = defs
            .iter()
            .filter(|d| d.policy_type == PolicyType::Wildcard)
            .count();
