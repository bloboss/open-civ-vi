...
impl BuiltinImprovement {
    ...
    pub fn yield_bonus(self) -> YieldBundle {
        ...
        match self {
            ...
            BuiltinImprovement::Sphinx => YieldBundle::new()
                .with(YieldType::Culture, 1)
                .with(YieldType::Faith, 1),
            BuiltinImprovement::Stepwell => YieldBundle::new()
            ...
            BuiltinImprovement::Chateau => YieldBundle::new()
            ...
            BuiltinImprovement::Kurgan => YieldBundle::new()
            ...
            BuiltinImprovement::OffshoreWindFarm => {
                YieldBundle::new().with(YieldType::Production, 2)
            }
            BuiltinImprovement::GeothermalPlant => YieldBundle::new()
                .with(YieldType::Science, 2)
                .with(YieldType::Production, 1),
            BuiltinImprovement::Seastead => YieldBundle::new()
