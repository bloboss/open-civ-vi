...
#[derive(Debug, Clone, Copy)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct HaLongBay { pub id: NaturalWonderId }
impl NaturalWonder for HaLongBay {
    fn id(&self) -> NaturalWonderId { self.id }
    fn name(&self) -> &'static str { "Ha Long Bay" }
    fn appeal_bonus(&self) -> i32 { 2 }
    fn yield_bonus(&self) -> YieldBundle {
        YieldBundle::new()
            .with(crate::YieldType::Food, 3)
...
#[derive(Debug, Clone, Copy)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct Eyjafjallajokull { pub id: NaturalWonderId }
impl NaturalWonder for Eyjafjallajokull {
    fn id(&self) -> NaturalWonderId { self.id }
    fn name(&self) -> &'static str { "Eyjafjallajokull" }
    fn appeal_bonus(&self) -> i32 { 2 }
    fn yield_bonus(&self) -> YieldBundle {
        YieldBundle::new()
            .with(crate::YieldType::Culture, 1)
...
#[derive(Debug, Clone, Copy)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct GiantsCauseway { pub id: NaturalWonderId }
impl NaturalWonder for GiantsCauseway {
    fn id(&self) -> NaturalWonderId { self.id }
    fn name(&self) -> &'static str { "Giant's Causeway" }
    fn appeal_bonus(&self) -> i32 { 2 }
    fn yield_bonus(&self) -> YieldBundle {
...
#[derive(Debug, Clone, Copy)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct Lysefjorden { pub id: NaturalWonderId }
impl NaturalWonder for Lysefjorden {
    fn id(&self) -> NaturalWonderId { self.id }
    fn name(&self) -> &'static str { "Lysefjorden" }
    fn appeal_bonus(&self) -> i32 { 2 }
    fn yield_bonus(&self) -> YieldBundle {
        YieldBundle::new().with(crate::YieldType::Production, 1)
    }
