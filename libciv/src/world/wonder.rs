...
impl NaturalWonder for Pantanal {
    ...
    fn movement_cost(&self) -> MovementCost {
        MovementCost::TWO
    } // marsh-like movement cost
}

#[derive(Debug, Clone, Copy)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct Piopiotahi {
    pub id: NaturalWonderId,
}
...
impl NaturalWonder for Pamukkale {
    ...
    fn movement_cost(&self) -> MovementCost {
        MovementCost::ONE
    } // passable, provides fresh water
}

#[derive(Debug, Clone, Copy)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct WhiteDesert {
    pub id: NaturalWonderId,
}
...
#[derive(Debug, Clone, Copy)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct HaLongBay {
    pub id: NaturalWonderId,
}
impl NaturalWonder for HaLongBay {
    fn id(&self) -> NaturalWonderId {
        self.id
    }
    fn name(&self) -> &'static str {
...
#[derive(Debug, Clone, Copy)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct Eyjafjallajokull {
    pub id: NaturalWonderId,
}
impl NaturalWonder for Eyjafjallajokull {
    fn id(&self) -> NaturalWonderId {
        self.id
    }
    fn name(&self) -> &'static str {
...
#[derive(Debug, Clone, Copy)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct GiantsCauseway {
    pub id: NaturalWonderId,
}
impl NaturalWonder for GiantsCauseway {
    fn id(&self) -> NaturalWonderId {
        self.id
    }
    fn name(&self) -> &'static str {
    ...
    fn yield_bonus(&self) -> YieldBundle {
        YieldBundle::new().with(crate::YieldType::Culture, 1)
    }
    fn movement_cost(&self) -> MovementCost {
        MovementCost::Impassable
    }
...
#[derive(Debug, Clone, Copy)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct Lysefjorden {
    pub id: NaturalWonderId,
}
impl NaturalWonder for Lysefjorden {
    fn id(&self) -> NaturalWonderId {
        self.id
    }
    fn name(&self) -> &'static str {
...
impl BuiltinNaturalWonder {
    pub fn as_def(&self) -> &dyn NaturalWonder {
        match self {
            ...
            BuiltinNaturalWonder::HaLongBay(w) => w,
            BuiltinNaturalWonder::Eyjafjallajokull(w) => w,
            BuiltinNaturalWonder::GiantsCauseway(w) => w,
            BuiltinNaturalWonder::Lysefjorden(w) => w,
        }
    }
}
